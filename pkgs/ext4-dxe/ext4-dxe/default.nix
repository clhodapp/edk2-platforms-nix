...
# tianocore/edk2-platforms (Features/Ext4Pkg), compiled against nixpkgs'
# edk2 core. The driver verifies metadata checksums (CRC32c, including
...
edk2.mkDerivation "Features/Ext4Pkg/Ext4Pkg.dsc" {
  pname = "ext4-dxe";
  version = "${version.upstream}.${toString version.revision}";
